...
const HeroSection: React.FC = () => {
  ...
  return <section className="relative overflow-hidden">
      ...
      <div className="w-full h-screen relative">
        <video className="w-full h-full object-cover" autoPlay muted loop playsInline preload="metadata" poster="/lovable-uploads/1c9721c3-7053-4d03-ad41-97ed9a163d6f.png" aria-label="Local business owners and contractors collaborating on site and in-office">
      ...
      <div className="absolute top-0 left-0 w-full h-full">
        ...
        <div className="container mx-auto h-full flex flex-col justify-between relative px-4 py-8">
          ...
          duration: 0.5
            ...
            <Link to="/industries">
              <BusinessTagButton text="Trusted by local businesses across the Hudson Valley" className="shadow-lg bg-hvcg-blue/95 hover:bg-hvcg-blue text-xs sm:text-sm" />
            </Link>
          </motion.div>

          {/* Main content container */}
          <div className="flex-1 flex flex-col justify-center items-center min-h-0 md:py-20 lg:py-24 py-[44px]">
      ...
      <div className="fixed bottom-4 left-4 right-4 md:hidden flex z-30">
        <a href="tel:+18455551234" className="flex-1 bg-hvcg-green text-white py-3 font-medium rounded-l-lg flex items-center justify-center shadow-lg">
        ...
        <Link to="/services" className="flex-1 bg-hvcg-blue text-white py-3 font-medium rounded-r-lg flex items-center justify-center shadow-lg">
          <span className="h-5 w-5 mr-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
