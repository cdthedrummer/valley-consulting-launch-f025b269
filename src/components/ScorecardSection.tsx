          ...
          <div className="bg-warm-cream rounded-3xl p-10 md:p-16">
            ...
            <div className="mb-12">
              ...
              <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
                <img src="/images/tech-logos/claude-logo.png" alt="Anthropic Claude" className="h-12 md:h-14 object-contain opacity-80 hover:opacity-100 transition-opacity" />
                <img src="/images/tech-logos/chatgpt-logo.png" alt="OpenAI ChatGPT" className="h-12 md:h-14 object-contain opacity-80 hover:opacity-100 transition-opacity" />
                <img src="/images/tech-logos/gemini-logo.png" alt="Google Gemini" className="h-12 md:h-14 object-contain opacity-80 hover:opacity-100 transition-opacity" />
              </div>
            </div>
            ...
            <div className="mb-12">
              ...
              <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
                <img src="/images/tech-logos/lovable-logo.png" alt="Lovable" className="h-12 md:h-14 object-contain opacity-80 hover:opacity-100 transition-opacity" />
                <img src="/images/tech-logos/replit-logo.png" alt="Replit" className="h-12 md:h-14 object-contain opacity-80 hover:opacity-100 transition-opacity" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
                <img src="/images/tech-logos/census-wordmark.png" alt="US Census Bureau" className="h-12 md:h-14 object-contain opacity-80 hover:opacity-100 transition-opacity" />
              </div>
            </div>
