...
const PricingCard: React.FC<PricingCardProps> = ({ 
  ...
  const cardClasses = highlighted 
    ? "bg-white border-none shadow-xl border-t-4 border-hvcg-green relative transform scale-105 z-10" 
    : "bg-white border-none shadow-lg border-t-4 border-hvcg-blue-dark relative";

  const buttonClasses = highlighted
    ? "w-full bg-hvcg-green hover:bg-hvcg-green-light"
    : "w-full bg-hvcg-blue-dark hover:bg-hvcg-blue";
